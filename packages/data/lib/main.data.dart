...
final repositoryInitializerProvider =
  ...
  final adapters = <String, RemoteAdapter>{
    'ingredients':
        ref.watch(internalFlutterDataIngredientsRemoteAdapterProvider),
    'menus': ref.watch(internalFlutterDataMenusRemoteAdapterProvider),
    'recipes': ref.watch(internalFlutterDataRecipesRemoteAdapterProvider),
    'shopping-lists':
        ref.watch(internalFlutterDataShoppingListsRemoteAdapterProvider),
    'userPreferences':
        ref.watch(internalFlutterDataUserPreferencesRemoteAdapterProvider)
  };
...
extension RepositoryWidgetRefX on WidgetRef {
  Repository<FlutterDataIngredient> get flutterDataIngredients =>
      watch(flutterDataIngredientsRepositoryProvider)
        ..remoteAdapter.internalWatch = watch;
  Repository<FlutterDataMenu> get flutterDataMenus =>
      watch(flutterDataMenusRepositoryProvider)
        ..remoteAdapter.internalWatch = watch;
  Repository<FlutterDataRecipe> get flutterDataRecipes =>
      watch(flutterDataRecipesRepositoryProvider)
        ..remoteAdapter.internalWatch = watch;
  Repository<FlutterDataShoppingList> get flutterDataShoppingLists =>
      watch(flutterDataShoppingListsRepositoryProvider)
        ..remoteAdapter.internalWatch = watch;
  Repository<FlutterDataUserPreference> get flutterDataUserPreferences =>
      watch(flutterDataUserPreferencesRepositoryProvider)
        ..remoteAdapter.internalWatch = watch;
}
